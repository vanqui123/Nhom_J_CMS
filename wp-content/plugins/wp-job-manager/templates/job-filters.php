	...
	<div class="search_jobs">
		...
		<div class="d-flex w-100 px-4 py-3">
			<div class="w-100 d-flex bg-white">
				<label for="search_keywords" class="text-primary my-auto fs-4 ps-2 pe-1 d-block">
			...
			<div class="w-50 ms-3 d-flex bg-white">
				<label for="search_location" class="text-primary my-auto fs-4 ps-2 pe-1 d-block">
					<i class="fa-sharp fa-solid fa-location-dot"></i>
				</label>
				<input class="son-input rounded-0 border-0 text-secondary" type="text" name="search_location" id="search_location" placeholder="<?php esc_attr_e('Location', 'wp-job-manager'); ?>" value="<?php echo esc_attr($location); ?>" />
			</div>
		</div>
